...
class TasksPreviewParameterProvider : PreviewParameterProvider<Map<Boolean, List<Task>>> {
    override val values: Sequence<Map<Boolean, List<Task>>>
        get() = sequenceOf(
            mapOf(
                false to listOf(
                    Task(
                    ...
                    Task(
                        ...
                        created = Clock.System.now(),
                        updated = Clock.System.now(),
                        reminder = Clock.System.now().minus(duration = 2.hours),
